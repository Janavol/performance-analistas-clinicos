...
Tem duas abas independentes: a análise do período atual, e uma análise por
temporalidade que compara vários períodos (arquivos Excel exportados pela
primeira aba) entre si.
"""
...
# ---------------------------------------------------------------------------
# Abas — a análise atual e a análise por temporalidade são independentes
# ---------------------------------------------------------------------------
tab_atual, tab_temporal = st.tabs(["📊 Análise atual", "📈 Análise por Temporalidade"])
with tab_atual:
    render_main_tab()
with tab_temporal:
    temporal.render()
